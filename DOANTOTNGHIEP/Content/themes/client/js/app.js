        ...
        $.ajax({
            ...
            success: function (responseJSON) {
                if (responseJSON.status) {
                    var img = '<div class="col-md-3 image-item"><a href="javascript: void(0);" class="btn btn-xs btn-danger image-del">Xóa</a><div class="image-option  btn-xs btn-success"><input type="radio" name="thumb" id="img-input-'+responseJSON.link+'" value="'+responseJSON.link+'"><label for="img-input-'+responseJSON.link+'"> Đại diện</label></div><img src="/'+responseJSON.link+'" class="img-responsive">';
